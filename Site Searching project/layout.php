...
<link rel="stylesheet" href="http://www.w3schools.com/lib/w3.css">
	<head>
		...
		<style type="text/css">
			...
			#content #contentbar { margin:0; padding:0; float:center; width:100%;}
		...
		<div id="page">
			...
			<div id="content">
				<div id="content-inner">
                 ...
                 Site Name to Search   : <input type="text" style="font-face: 'Comic Sans MS'; font-size: small; color: teal; background-color:#E6E6FA ; border: 1pt ridge lightgrey"name="name" required><br><br><div class="sub" ><input type="submit" name="submit"style="font-face: 'Comic Sans MS';cursor:pointer; font-size: medium; color: white; background-color: #416093; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></div><br>
            </form>
                            <?php

//$name = $_SESSION['name'];
/*if(isset($_SESSION['nd'])&&!empty($_SESSION['nd'])){
      echo "<p style='color:red;text-align:left;font-size:21px;padding-top:10px'>
               <strong>Please fill the box.</strong></p>";
      unset($_SESSION['nd']);
                                  }*/
if(isset($_SESSION['noresult'])&&!empty($_SESSION['noresult'])){
      echo "<p style='color:red;text-align:left;font-size:21px;padding-top:10px'>
               <strong>No result found.</strong></p>";
      unset($_SESSION['noresult']);
                                  }

?>
<div class="w3-content w3-section">
  <img class="mySlides" src="gp1.jpg" style="width:100%">
  <img class="mySlides" src="gp2.jpg" style="width:100%">
  <img class="mySlides" src="gp3.jpg" style="width:100%">
</div>
                            <script>
var myIndex = 0;
carousel();
			...
			<div id="footerblurb">
				<div id="footerblurb-inner">
					...
					<div class="column">
						...
						<p>01700-100121  Grameenphone, widely abbreviated as GP, is the leading telecommunications service provider in Bangladesh. With more than 56 million subscribers, Grameenphone is the largest mobile phone operator in the country.</p>
					</div>	
