	...
	<body>
		<div id="page">
			...
			<div class="feature">
				...
				<h1>Search Result for <?php echo $name; ?></h1>
				</div>
			</div>
		            <?php
if(isset($_POST['name'])){
    ...
    if(!empty($_POST['name']))
    {
    $sql=" SELECT `Site_id`,`Sub_center`,`3G`,`Type`,`NTTN`,`HRS`,`Site_name` FROM gp_oss.`sitenames` WHERE `Site_name` like '%$name%' ";
    $q=mysql_query($sql);
        if(mysql_num_rows($q)==0)
        {
            
              $_SESSION['noresult']="noresult";
         header('Location: searchpage.php');
        }
    }
    }
    ...
    ?>
			...
			<div id="content">
				<div id="content-inner">
					...
					<main id="contentbar">
						<div class="article">
							           <div class="sub"><form action="layout3.php"><input type="submit" style="font-face: 'Comic Sans MS';cursor:pointer; font-size: medium; color: white; background-color: #416093; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Update This Tuple&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"><br><br><br></form></div></form>
                <div class="table">
        <table id="t01">
              <tr>
              <th>Site_name</th>
